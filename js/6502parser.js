...
function peg$parse(input, options) {
  ...
  function peg$parseOperand() {
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$parseIndirectX();
      if (s0 === peg$FAILED) {
        s0 = peg$parseIndirectY();
        if (s0 === peg$FAILED) {
          s0 = peg$parseIndirect();
          if (s0 === peg$FAILED) {
            s0 = peg$parseAbsoluteX();
            if (s0 === peg$FAILED) {
              s0 = peg$parseAbsoluteY();
              if (s0 === peg$FAILED) {
  ...
  function peg$parseResDirective() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8;
  ...
  if (peg$result !== peg$FAILED && peg$currPos === input.length) {
    ...
    throw peg$buildSimpleError(
      peg$SyntaxError.buildMessage(peg$maxFailExpected, peg$maxFailPos < input.length ? input.charAt(peg$maxFailPos) : null),
